...
userRouter.get("/feed", userAuth, async (req, res) => {
    try {
        ...
        let limit = parseInt(req.query.limit) || 100;        //Increasing this will increase the number of users to be shown to the user!
        ...
        const users = await User.find({
            $and: [
                ...
                { _id: { $ne: loggedInUser._id } }  //this condition in which a user doesn't send any request to anyone
            ]
